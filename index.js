...
document.body.insertBefore(paragraphElement, document.body.firstChild);

function updateParagraph() {
    const randomIndex = Math.floor(Math.random() * wordsArray.length);
    paragraphElement.textContent = wordsArray[randomIndex];
}

updateParagraph();

window.addEventListener("load", updateParagraph);
